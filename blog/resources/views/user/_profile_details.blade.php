<div class="container mx-auto px-4">
  @if(isset($data) && count($data) > 0)
    <x-alert-component shortmessage="Success!!" longmessage="Data Listing!" cssclass="green" />
    <div
  ...
  @else
    <x-alert-component shortmessage="Error!!" longmessage="Data not found!" cssclass="red" />
    <p>No users found.</p>
  @endif
</div>